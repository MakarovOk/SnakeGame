...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback  {
    ...
    private static final int colorSnake = Color.GREEN;
    private int snakeSpeed = 800;
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if(checkGameOver(headPositionX,headPositionY)){
                    ...
                    builder.setPositiveButton("Играть заново", new DialogInterface.OnClickListener() {
                        @Override
    ...
    private Paint createPointColor(){
        if(pointColor == null){
            ...
            pointColor.setColor(colorSnake);
